...
class Replier{
    ...
    loadReplies(){
        ...
        let replies_classes_files = getAllInDir('./replies/reply_classes','.js','reply classes') // This uses the working directory as the root folder (where the bot is running)
