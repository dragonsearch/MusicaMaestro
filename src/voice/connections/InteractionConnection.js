...
class InteractionConnection{
    ...
    constructor(interaction){
        ...
        this.possible_to_join = this.guild_available && this.member_in_voice_channel && !this.bot_in_voice_channel;
    ...
    InTheSameVoiceChannel(){
        ...
        if (connection != undefined){
            return connection.joinConfig.channelId == this.interaction.member.voice.channelId;
        }else{
            return false;
        }
    }
